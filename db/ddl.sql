CREATE TABLE bit_pay_payment_methods (
  id serial UNIQUE,
...
CREATE INDEX index_bit_pay_payment_methods_kb_account_id ON bit_pay_payment_methods(kb_account_id);
CREATE INDEX index_bit_pay_payment_methods_kb_payment_method_id ON bit_pay_payment_methods(kb_payment_method_id);

CREATE TABLE bit_pay_transactions (
  id serial UNIQUE,
  bit_pay_response_id bigint /*! unsigned */ NOT NULL,
...
CREATE INDEX index_bit_pay_transactions_kb_payment_id ON bit_pay_transactions(kb_payment_id);
CREATE INDEX index_bit_pay_transactions_bit_pay_response_id ON bit_pay_transactions(bit_pay_response_id);

CREATE TABLE bit_pay_responses (
  id serial UNIQUE,
  api_call varchar(255) NOT NULL,
...
CREATE INDEX index_bit_pay_responses_kb_payment_id_kb_tenant_id ON bit_pay_responses(kb_payment_id, kb_tenant_id);
