...
ActiveRecord::Schema.define(:version => 20140410153635) do
  create_table "bit_pay_payment_methods", :force => true do |t|
    t.string   "kb_payment_method_id"      # NULL before Kill Bill knows about it
    t.string   "token"                     # bit_pay id
  ...
  add_index(:bit_pay_payment_methods, :kb_account_id)
  add_index(:bit_pay_payment_methods, :kb_payment_method_id)

  create_table "bit_pay_transactions", :force => true do |t|
    t.integer  "bit_pay_response_id",  :null => false
    t.string   "api_call",                       :null => false
    t.string   "kb_payment_id",                  :null => false
    t.string   "kb_payment_transaction_id",      :null => false
    t.string   "transaction_type",               :null => false
    t.string   "payment_processor_account_id"
    t.string   "txn_id"                          # bit_pay transaction id
    # Both null for void
  ...
  add_index(:bit_pay_transactions, :kb_payment_id)
  add_index(:bit_pay_transactions, :bit_pay_response_id)

  create_table "bit_pay_responses", :force => true do |t|
    t.string   "api_call",          :null => false
  ...
  add_index(:bit_pay_responses, [:kb_payment_id, :kb_tenant_id])
end
