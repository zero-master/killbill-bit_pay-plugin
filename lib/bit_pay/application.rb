...
# curl -v http://127.0.0.1:9292/plugins/killbill-bit_pay/form
get '/plugins/killbill-bit_pay/form', :provides => 'html' do
  ...
  @form = plugin(session).payment_form_for(order_id, account_id, :bit_pay, options) do |service|
    # Add your custom hidden tags here, e.g.
    #service.token = config[:bit_pay][:token]
    submit_tag 'Submit'
  end
...
# curl -v http://127.0.0.1:9292/plugins/killbill-bit_pay/1.0/pms/1
get '/plugins/killbill-bit_pay/1.0/pms/:id', :provides => 'json' do
...
# curl -v http://127.0.0.1:9292/plugins/killbill-bit_pay/1.0/transactions/1
get '/plugins/killbill-bit_pay/1.0/transactions/:id', :provides => 'json' do
...
# curl -v http://127.0.0.1:9292/plugins/killbill-bit_pay/1.0/responses/1
get '/plugins/killbill-bit_pay/1.0/responses/:id', :provides => 'json' do
